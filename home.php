...
?>
        ...
        <div class="txtwrap">
		  ...
		  <br>
		      <h4> Department: <?php if(isset($_SESSION['username'])){ $usersData = getUsersData(getId($_SESSION['username'])); echo $usersData['department'];} ?>
          </h4>
          <br>
          <h4> Year of admission: <?php if(isset($_SESSION['username'])){ $usersData = getUsersData(getId($_SESSION['username'])); echo $usersData['adm_year'];} ?>
          </h4>
          <br>
