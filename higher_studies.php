...
<div >
  <main class="hoc container clear"> 
    ...
    <p>NOTE: In the form given below, you can choose to add the admission receipt later. Use the link given below when you wish to add the college admission receipt.</p> 
    
    
    <a href="adm_receipt.php?" style="color:white; text-decoration:underline">Click here to add Admission receipt(Only if college admission is complete and if you haven't )</a>
    <br>
    <br>
    <br>
    <br>

      <h6 class="heading">ENTER HIGHER STUDIES DETAILS</h6>

<!--       FORM STARTS -->
<div class="insert_form">
  <form onSubmit=" return validateForm()"  name="insertwork" action="php/ins_higherstudies.php" method="POST" enctype="multipart/form-data">
   ...
   <label for="rollno">Name:</label>
    ...
    <label for="name_exam">Exam Name:</label>
    <!--<input type="text" id="name_exam" name="name_exam" placeholder="Eg: GRE/GMAT,etc." required>-->
    <select name="name_exam">
    ...
    <label for="year">Year in which you gave this exam:</label>
    <select name="year">
    <option>LY</option>
    <option>TY</option>
    <option >SY</option>
    ...
    <option>Completed B.Tech</option>
    </select>
    ...
    <label for="con_by">Attach Admission Receipt(optional):</label>
...
<div class="flip-card"  style="padding-bottom: 200px;     margin-bottom: -130px; margin-top: 150px;">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
      ...
      <p>Note : The certificate file name should be saved as srno_rollno. eg: Your first exam certificate filename will be 1_<?php 
  if(isset($_SESSION['username'])){ $usersData = getUsersData(getId($_SESSION['username'])); echo $usersData['rollno']; } ?>, Second exam certificate filename will be 2_<?php if(isset($_SESSION['username'])){ $usersData = getUsersData(getId($_SESSION['username'])); echo $usersData['rollno']; } ?>.</p>
    </div>
  </div>
</div>    
    
<div class="flip-card" 	style="padding-bottom: 200px;     margin-bottom: -130px;">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    <h4> #2 Image name </h4>
    </div>
